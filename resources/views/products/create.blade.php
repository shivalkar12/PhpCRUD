      ...
      <div class="col-md-10">
        <div class="card border-0 shadow-lg">
          <div class="card-header bg-dark">
            <h3 class="text-white d-flex justify-content-center">Create Product</h3>
          </div>
          <form enctype="multipart/form-data" action="{{ route('products.store') }}" method="post">
            @csrf
          <div class="card-body">
            <div class="mb-3">
              <label for="" class="form-level h5">Name</label>
            ...
            <div class="mb-3">
              <label for="" class="form-level h5" >Sku</label>
            ...
            <div class="mb-3">
              <label for="" class="form-level h5">Price</label>
            ...
            <div class="mb-3">
              <label for="" class="form-level h5">Description</label>
             <textarea placeholder="Description" class="form-control" name="description" cols="30" rows="5">
              {{old('description')}}</textarea>
            </div>
            <div class="mb-3">
              <label for="" class="form-level h5">Image</label>
